...
this.primereact.overlaypanel = (function (exports, React, reactTransitionGroup, core) {
  'use strict';
    ...
    _createClass(OverlayPanel, [{
      ...
      value: function show(event, target) {
        ...
        if (this.state.visible) {
          ...
          this.setState({
            ...
            OverlayEventBus.on('overlay-click', _this6.overlayEventListener);
          });
        }
      }
    }, {
      ...
      value: function hide() {
        ...
        this.setState({
          ...
          OverlayEventBus.off('overlay-click', _this7.overlayEventListener);
